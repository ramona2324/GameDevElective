...
<body class="flex justify-center items-center" style="background: #f6f6f6;">
    <div class="flex justify-center items-center min-h-screen">
      <div class="text-center">
          <img src="images/Tuon.png" alt="Tuon" class="lg:h-64 md:h-32 h-24 mx-auto" />
          <div class="mt-6 lg:mt-8 lg:ml-24">
              <button class="px-8 py-1 lg:text-xl text-white text-sm">
                  <svg class="h-12 w-12 lg:h-16 lg:w-16" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">
